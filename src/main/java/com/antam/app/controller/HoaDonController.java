...
import com.antam.app.controller.hoadon.DoiThuocFormController;
import com.antam.app.controller.hoadon.TraThuocFormController;
import com.antam.app.controller.hoadon.XemChiTietHoaDonFormController;
    ...
    public void initialize() {
        ...
        this.btnExchangeMedicine.setOnAction((e) -> {
            ...
            if (selectedHoaDon == null) {
                ...
                DoiThuocFormController controller = dialog.getController();
        ...
        this.btnReturnMedicine.setOnAction((e) -> {
            ...
            if (selectedHoaDon == null) {
                ...
                // Lấy controller và set Thuoc vào
                TraThuocFormController controller = dialog.getController();
                controller.setHoaDon(selectedHoaDon);
                controller.showData(selectedHoaDon);
                dialog.showAndWait();
                HoaDon_DAO hoaDonDAO = new HoaDon_DAO();
